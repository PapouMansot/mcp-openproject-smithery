...
export const missingConfigMessage = "OpenProject configuration is missing. Please provide OPENPROJECT_API_KEY and OPENPROJECT_URL.";
export const missingConfigResult = {
    content: [
        {
            type: "text",
 ...
 */
export const isNotFoundError = (error) => axios.isAxiosError(error) && error.response?.status === 404;
/**
 ...
 */
export function getOpenProjectApi(config) {
